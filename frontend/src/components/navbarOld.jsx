	...
	return (
		<div className="navbar">
			...
			<Link to="/houses">
				<span>
					Houses
					<hr id="Houses" className={active === 'Houses' ? 'active' : ''} />
				</span>
			</Link>
			<Link to="/bills">
				<span>
					Bills
					<hr id="Bills" className={active === 'Bills' ? 'active' : ''} />
				</span>
			</Link>
			<Link to="/analysis">
				<span>
					Analysis
					<hr id="Analysis" className={active === 'Analysis' ? 'active' : ''} />
				</span>
			</Link>
			<Link to="/profile">
				<span>
					Profile
					<hr id="Profile" className={active === 'Profile' ? 'active' : ''} />
				</span>
			</Link>
			<Link to="/map">
				<span>
